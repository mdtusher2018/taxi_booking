...
import 'package:taxi_booking/role/driver/featured/authentication/models/signup_from_model.dart';
...
class AuthController extends _$AuthController {
  ...
  Future<void> otpVerification({required String otp}) async {
    ...
    if (result is FailureResult) {
      ...
      state = AsyncData({"otpVerified": (result as Success).data as bool});
    }
    return;
  }
}
