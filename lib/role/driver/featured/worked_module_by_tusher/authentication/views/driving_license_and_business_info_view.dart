...
class _DrivingLicenseAndBusinessInfoViewState
  ...
  final TextEditingController businessTypeController = TextEditingController(
    text: kDebugMode ? 'IT Consulting' : null, // Dummy data in debug mode
  );
  ...
  issuingMunicipalityController = TextEditingController(
    text: kDebugMode ? 'City of Exampletown' : null, // Dummy data in debug mode
  );
  final TextEditingController licenseExpiryDateController =
      TextEditingController(
        text: kDebugMode ? '12/2025' : null, // Dummy data in debug mode
      );
  ...
  void _submit() {
    ...
    String licenseExpiryDate = licenseExpiryDateController.text.trim();

    // Trim business license fields
    String businessType = businessTypeController.text.trim();
    ...
    if (widget.withCar) {
      if (businessType.isEmpty) {
        CustomToast.showToast(message: 'Please enter business type');
        return;
      }
    ...
    formNotifier.updateDrivingAndBusinessInfo(
      ...
      businessType: widget.withCar ? businessTypeController.text : null,
      organizationNumber:
          widget.withCar ? organizationNumberController.text : null,
      taxId: widget.withCar ? taxIdController.text : null,
      licenseNumber: widget.withCar ? licenseNumberController.text : null,
      issuingMunicipality:
          widget.withCar ? issuingMunicipalityController.text : null,
