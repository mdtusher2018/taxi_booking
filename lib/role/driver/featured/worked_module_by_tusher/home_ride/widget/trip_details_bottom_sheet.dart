...
class WaitingForPaymentConfirmSheet extends ConsumerWidget {
  const WaitingForPaymentConfirmSheet({super.key});
  ...
  Widget _endRideButton(WidgetRef ref, String rideId) => Padding(
    ...
    child: Opacity(
      opacity: 0.5,
      child: CustomButton(title: "Waiting for confirm", onTap: () {}),
    ),
  );
}
