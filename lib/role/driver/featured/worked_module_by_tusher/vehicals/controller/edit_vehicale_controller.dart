...
part 'edit_vehicale_controller.g.dart';

@riverpod
class EditVehicalController extends _$EditVehicalController {
  ...
  Future<void> editVehical({
    ...
    state = AsyncLoading();
    final response = await repo.editVehical(
    ...
    if (response is FailureResult) {
      ...
      state = AsyncData((response as Success).data as EditVehicleResponse);
    }
  }
}
