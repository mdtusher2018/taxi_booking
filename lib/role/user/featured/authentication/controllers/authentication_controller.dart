...
import 'package:taxi_booking/role/user/featured/authentication/models/sign_in_response.dart';
import 'package:taxi_booking/role/user/featured/authentication/models/signup_response.dart';
...
//   void toggleChangeAuth(String auth) {
//     selectedAuth.value = auth;
//   }
//   @override
//   void onInit() {
//     super.onInit();
//     // Don't set the value here as it might cause build-time conflicts
//     // Let the view handle initial state setting
//   }
//   @override
//   void onReady() {
//     super.onReady();
//     // Set initial value after the widget is fully ready
//     final tab = Get.arguments ?? Get.parameters['tab'] ?? 'login';
//     selectedAuth.value = tab;
//   }
//   Future<void> login({
...
//         };
//         log(body.toString());
//         final response = await _apiService.post(ApiEndpoints.signup, body);
//         final loginResponse = SignupResponse.fromJson(response);
//         if (loginResponse.statusCode == 201) {
//           final token = loginResponse.data.sendOtp.token;
//           await _localStorage.saveString(StorageKey.token, token);
//           Get.to(() => SubmitAndSignUpView());
//         } else {
//           throw Exception(loginResponse.message);
//         }
//       },
