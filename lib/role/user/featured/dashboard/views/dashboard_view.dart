...
import 'package:taxi_booking/role/user/featured/chat/views/chat_view.dart';
...
class UserDashboardView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UserDashboardView> createState() => _DashboardViewState();
}

class _DashboardViewState extends ConsumerState<UserDashboardView> {
  int selectedIndex = 2;
