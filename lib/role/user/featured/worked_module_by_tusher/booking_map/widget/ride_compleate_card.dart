...
class _ProfessionalDriverArrivedCardState
    extends ConsumerState<RideCompleatedCard> {
  @override
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(
                            state.acceptedDriverInfo?.name ?? "Unnamed",
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomText(title: "Narayangonj Dhaka"),
                            ],
                          ),
                        ),
                      ],
            ...
            Row(
              ...
              children: [
                Container(width: 60, color: Colors.grey, height: 1),
                Container(
                ...
                _buildActionButton(
                  ...
                  onTap: () {
                    ...
                    CustomToast.showToast(
                      message:
                          'Calling ${state.acceptedDriverInfo?.name ?? ""}',
                      isError: false,
                    );
