...
import 'package:taxi_booking/role/user/featured/worked_module_by_tusher/chat/controller/message_controller.dart';
...
class UserMessageView extends ConsumerStatefulWidget {
  ...
  const UserMessageView({super.key, required this.reciverId});

  @override
  ConsumerState<UserMessageView> createState() => _MessageViewState();
}

class _MessageViewState extends ConsumerState<UserMessageView> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ref
          ...
          .openChat(widget.reciverId);
    });
  }

  @override
  Widget build(BuildContext context) {
    final state = ref.watch(userMessageControllerProvider);
  ...
  Widget _buildChat(UserMessageState state) {
    return Column(
      children: [
        Expanded(
